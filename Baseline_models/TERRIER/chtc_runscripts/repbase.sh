...
#   CKPT_DIR="${FOLD_DIR}/lightning_logs/version_1/checkpoints"
...
python3 compute_metrics_validation.py /staging/kkumari/terrsystem/TERRIER repbase  $THRESHOLD
python3 compute_metrics_validation.py /staging/kkumari/terrsystem/TERRIER repetdb  $THRESHOLD
python3 compute_metrics_validation.py /staging/kkumari/terrsystem/TERRIER mntedb  $THRESHOLD