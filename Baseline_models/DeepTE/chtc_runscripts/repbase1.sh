...
#   for fold in {3..4}; do
#     echo "=== Fold $fold ==="
#     INPUT_FASTA_TRAIN="${data_dir}/train_${fold}.txt"
#     INPUT_FASTA_TEST="${data_dir}/test_${fold}.txt"


#     OUT_DIR="/staging/kkumari/terrsystem/DEEPTE/${DATASET_NAME}/${fold}/order/"
#     mkdir -p "${OUT_DIR}"

#     python train_deepte.py $INPUT_FASTA_TRAIN $INPUT_FASTA_TEST 0 $OUT_DIR "${DATASET_NAME}_order_${fold}"


#     OUT_DIR="/staging/kkumari/terrsystem/DEEPTE/${DATASET_NAME}/${fold}/SF/"
#     mkdir -p "${OUT_DIR}"
...
python summarize_validation_metrics.py -s /staging/kkumari/terrsystem/DEEPTE/ -d repbase \
        -m DEEPTE -o /staging/kkumari/terrsystem/DEEPTE/repbase_deepte_summary.csv



python summarize_validation_metrics.py -s /staging/kkumari/terrsystem/DEEPTE/ -d repetdb \
        -m DEEPTE -o /staging/kkumari/terrsystem/DEEPTE/repetdb_deepte_summary.csv



python summarize_validation_metrics.py -s /staging/kkumari/terrsystem/DEEPTE/ -d mntedb \
        -m DEEPTE -o /staging/kkumari/terrsystem/DEEPTE/mntedb_deepte_summary.csv
