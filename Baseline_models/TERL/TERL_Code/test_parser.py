...
def get_options(arguments):
    ...
    parser.add_argument(
        ...
        default = ['Outputs'],
        required = False,
        help = """Folder where the report, confusion matrix and learning curve
                are saved. Created if it does not exist. Default: Outputs"""
    )
    ...
    options.output_dir = options.output_dir[0]
