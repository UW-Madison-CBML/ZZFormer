...
run_name="pretraining_reponly_1024len_Apr8"
OUTPUT_DIR="/staging/kkumari/pretraining_reponly_1024len_Apr8/"
mkdir -p "$OUTPUT_DIR"
...
python train.py \
  ...
  --mode mlm \
  --train_dir "$WORKDIR"/data/all_dbs_seqs_andlabels/repbase_all_sequences_labels.pkl \
  --save_dir "$OUTPUT_DIR" \
...
OUTPUT_DIR2="/staging/kkumari/pretraining_reponly_1024len_Apr8/viz"
mkdir -p "$OUTPUT_DIR2"
...
run_name="${DATASET_NAME}_reponlyvis_w_prtrnd1024len_Apr8"
