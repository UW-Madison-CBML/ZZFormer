...
OUTPUT_DIR="/staging/kkumari/terrsystem/ZZFormer_CNN/$DATASET_NAME/"
mkdir -p "$OUTPUT_DIR"
...
# for fold in {0..4}; do
    # fold=0
run_name="${DATASET_NAME}_ZZFormerCNNCO4BS256_Wholeseq21top_${fold}"
