...
class TopoDataset(Dataset):
    ...
    def __init__(
        ...
        self.input_ids, self.attention_masks, self.topology_key_padding_mask = self._tokenize_all()
    ...
    def _tokenize_all(self):
        ...
        body_max = L - 2
        TOPO_IMAGE_WIDTH = 1024
        topology_key_padding_mask = torch.ones(
            (N, TOPO_IMAGE_WIDTH), dtype=torch.bool
        )
        for i, seq in enumerate(self.sequences):
            ...
            valid_body_len = min(len(body), TOPO_IMAGE_WIDTH)
            topology_key_padding_mask[i, :valid_body_len] = False
    ...
    def __getitem__(self, idx):
        ...
        item = {
            ...
            "sequence":        seq,
            "topology_key_padding_mask": self.topology_key_padding_mask,
        }
