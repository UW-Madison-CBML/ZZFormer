...
for fold in range(4,5):
    ...
    model_path = f'/staging/s/svaren/terrier_zzformer/{save_name}_f4.pth' #Repbase_f4, RepetDB_f4
...
#     save_path = f'/staging/svaren/terrier_zzformer/{save_name}_f{fold}.pth'
#     torch.save({
#         'epoch': n_epochs,
...
with open(f'/staging/svaren/terrier_zzformer/{save_name}_inference.pkl', 'wb') as f:
